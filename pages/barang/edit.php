          ...
          <form action="index.php" method="GET">
            <div class="card-body">
              <div class="mb-3">
                ...
                <input type="number" class="form-control" id="exampleInputId1" placeholder="Masukkan ID">
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                <label for="exampleInputPrice1" class="form-label">Harga*</label>
                <input type="number" class="form-control" id="exampleInputPrice1" placeholder="Masukkan Harga">
              </div>
            </div>
